...
export default function TaskSix({val = {}})
{
    ...
    function handleTaskSumbission(e)
    {
        ...
        if(id === 0)
        {
            ...
            .then((response) => {if(response.message === "Task Submitted Successfully!!!")
            {
                ...
                navigate("/day6", {state:{fromHome: { data }}});
            ...
            <div className="card ms-4 mt-2" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                <div className="card-header" id="headingOne">
                    <div className="row-lg-12 d-flex">
                        ...
                        <span style={{fontWeight: "600"}}>Day-6 Task Link :
                        <a href="https://docs.google.com/document/d/1ckh6RegMhmyBwqbbtYHygA8Y0Q10TqHW8fkjX0ZPw3g/edit"
