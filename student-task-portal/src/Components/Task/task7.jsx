...
export default function TaskSeven({val = {}})
{
    ...
    function handleTaskInput(e)
    {
        ...
        console.log("Submit", submit, stuId)
            ...
            <div className="card ms-4 mt-2" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                <div className="card-header" id="headingOne">
                    <div className="row-lg-12 d-flex">
                        ...
                        <span style={{fontWeight: "600"}}>Day-7 Task Link :
                        <a href="https://docs.google.com/document/d/1iza9j-P6zsN0gZ9ZVuNH0lMxdUeuAYfaGMPvyWL_IcY/edit?usp=sharing"
