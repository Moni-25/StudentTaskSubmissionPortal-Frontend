...
import TaskFour from "../Task/task4";
...
export default function ClassFour()
{
    ...
    let name = "JavaScript - Day -4: Functions";
    return(
        <>
                    ...
                    <div className="container">
                        <div className="card ms-4 mt-5" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                            ...
                            <div className="card-body">
                                ...
                                Introduction to functions<br></br>
                                function & return keyword<br></br>
                                types of function<br></br>
                                </span>
                                </div>
                                <div className="mt-2 mb-1" style={{fontWeight: "550"}}>Pre-Read:</div>
                                <div className="ms-4">
                                    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions" target="_blank" style={{fontFamily: "sans-serif", fontSize: "16px"}}>
