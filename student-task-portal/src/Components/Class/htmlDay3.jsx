...
import HtmlTaskThree from "../Task/htmlTask3";

export default function HtmlClassThree()
{
    const location = useLocation();
    const { fromHome } = location.state;
    let data = fromHome.data;
    //console.log("Day4",data);
    let name = "HTML & CSS- Day-3: HTML & CSS";
    return(
        <>
                    ...
                    <div className="container">
                        <div className="card ms-4 mt-5" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                            ...
                            <div className="card-body">
                                ...
                                Intro to pseudo-classes (link, visited,hover, active)<br></br>
                                box model: padding, margin, border<br></br>
                                Grid<br></br>
                                Flex - display, direction, wrap, flex-flow, justify-content, align-content<br></br>
                                position property: fixed, static, relative, absolute, sticky<br></br>
                                </span>
                                </div>
                                <div className="mt-2 mb-1" style={{fontWeight: "550"}}>Pre-Read:</div>
                                <div className="ms-4">
                                    <a href="https://github.com/rvsp/html-CSS/" target="_blank" style={{fontFamily: "sans-serif", fontSize: "16px"}}>
            ...
            <div className="col-lg-4 mt-5">
                ...
                <div className="col-lg-8">
                    ...
                    <HtmlTaskThree state={{ fromHome: { data }}} val={name}/>
                    </div>
                </div>
            </div>
