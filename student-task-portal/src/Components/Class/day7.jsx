...
import TaskSeven from "../Task/task7";
...
export default function ClassSeven()
{
    ...
    let name = "JavaScript - Day -7: Array methods";
    return(
        <>
                    ...
                    <div className="container">
                        <div className="card ms-4 mt-5" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                            ...
                            <div className="card-body">
                                ...
                                Map, Reduce,  Filter<br></br>
                                Other array methods practiced in the session<br></br>
                                </span>
                                </div>
                                <div className="mt-2 mb-1" style={{fontWeight: "550"}}>Pre-Read:</div>
                                <div className="ms-4">
                                    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array" target="_blank" style={{fontFamily: "sans-serif", fontSize: "16px"}}>
            ...
            <div className="col-lg-4 mt-5">
                ...
                <div className="col-lg-8">
                    ...
                    <TaskSeven state={{ fromHome: { data }}} val={name}/>
                    </div>
                </div>
            </div>
