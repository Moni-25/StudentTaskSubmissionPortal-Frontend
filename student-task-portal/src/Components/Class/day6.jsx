...
import TaskSix from "../Task/task6";
...
export default function ClassSix()
{
    ...
    let name = "JavaScript - Day -6: OOP in JS";
    return(
        <>
                    ...
                    <div className="container">
                        <div className="card ms-4 mt-5" style={{width: "50rem", padding: "0px", border: "2px solid #bfbfbf"}}>
                            ...
                            <div className="card-body">
                                ...
                                Understanding the basics of prototype<br></br>
                                What is classes in js?<br></br>
                                constructor<br></br>
                                need of setters/getters<br></br>
                                use of this key word in classes<br></br>
                                </span>
                                </div>
                                <div className="mt-2 mb-1" style={{fontWeight: "550"}}>Pre-Read:</div>
                                <div className="ms-4">
                                    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment" target="_blank" style={{fontFamily: "sans-serif", fontSize: "16px"}}>
            ...
            <div className="col-lg-4 mt-5">
                ...
                <div className="col-lg-8">
                    ...
                    <TaskSix state={{ fromHome: { data }}} val={name}/>
                    </div>
                </div>
            </div>
